...
const VariableProximity = lazy(() => import("../VariableProximity"));
  ...
  return (
    <div className="w-full bg-black font-sans" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-white text-md md:text-base max-w-sm">
          My interest in AI/ML and software development has driven me to seek
          out internships where I can apply my skills and contribute to
          innovative projects.
        </p>
      </div>
